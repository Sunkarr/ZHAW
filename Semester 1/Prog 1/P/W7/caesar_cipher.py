...
# Define the function and its behavior for encryption
"""
Prog 1
W05
P04, Aufgabe 1.2 Caesar cipher
...
# Prompt the user to input the message and display the decrypted message after encrypting and decrypting it
user_message = input("Please input the Message you want to encrypt and then decrypt: ")
print(decrypt(user_message))